...
- Stage Lyrics 2.0、歌词纹理和 GPU 上传预算：候选完成，等待 clean immutable release evidence；
- 3D Shelf parity、11/11 对象池与 600×600 soak：候选完成，等待 clean immutable release evidence；
...
M4 不得因 Stage/Shelf 候选完成而整体标记 complete；Sonic provenance 解除前保持 Open / Blocked。
