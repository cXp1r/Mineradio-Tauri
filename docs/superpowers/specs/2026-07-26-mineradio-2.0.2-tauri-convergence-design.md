...
### M4：Lyrics 与 Visual Parity（Open / Blocked）
...
- Sonic Topography：技术候选为 `partial`，clean-room provenance / exposure remediation 阻断完成判定；
...
M4 不得因 Stage/Shelf 已晋升而整体标记 complete；Sonic provenance 解除前保持 Open / Blocked。
