...
- [ ] 歌词舞台动画与 baseline 对齐。  — P8.s2c.3 secondary particle scaffolds landed (lyricParticles placeholder / connectorParticles placeholder); awaiting P8.s4 stage lyrics Three.js mesh + P8.s6 3D shelf to wire real shaders/lifecycles
