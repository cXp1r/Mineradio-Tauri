...
- [ ] 歌词舞台动画与 baseline 对齐。  — P8.s4.a stage-lyrics builder landed (THREE.Group with sun/glow/readability/text-shader/sparks; 16 userData.lyric fields; renderOrders 40/41/42/43/44; full YRC fragment shader verbatim); awaiting P8.s4.b lifecycle (showStageLine/GSAP lyr-in,bob,out + YRC timetable driver) and host mounting
